...
def upgrade() -> None:
    ...
    op.create_index('idx_knowledge_owner_access', 'knowledge_items', ['owner_user_id', 'access_level'], unique=False)
    op.create_index('idx_knowledge_type_access', 'knowledge_items', ['content_type', 'access_level'], unique=False)
    op.create_index(op.f('ix_knowledge_items_access_level'), 'knowledge_items', ['access_level'], unique=False)
    ...
    op.create_index('idx_permission_user_resource', 'permissions', ['user_id', 'resource_type', 'resource_id'], unique=False)
