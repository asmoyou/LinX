...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('is_system_template', sa.String(length=10), nullable=False, server_default='true'),
    ...
    op.create_index('ix_agent_templates_is_system_template', 'agent_templates', ['is_system_template'])
