    ...
    def is_duplicate(self, alert: Alert) -> bool:
        ...
        if alert_id in self.seen_alerts:
            ...
            if (now - last_seen).total_seconds() < self.window_seconds:
                logger.debug(
                    f"Alert {alert_id} is duplicate within {self.window_seconds}s window"
                )
                return True
...
class AlertThrottler:
    ...
    def should_throttle(self, alert: Alert) -> bool:
        ...
        self.alert_counts[source] = [
            ts for ts in self.alert_counts[source] if ts > cutoff
        ]
...
class SlackAlerter:
    ...
    def send_alert(self, alert: Alert) -> bool:
        ...
        try:
            ...
            logger.info(
                f"Slack alert sent: {alert.title}",
                extra={"alert_id": alert.alert_id}
            )
            return True
...
class TeamsAlerter:
    ...
    def send_alert(self, alert: Alert) -> bool:
        ...
        try:
            ...
            logger.info(
                f"Teams alert sent: {alert.title}",
                extra={"alert_id": alert.alert_id}
            )
            return True
...
class PagerDutyAlerter:
    ...
    def send_alert(self, alert: Alert) -> bool:
        ...
        try:
            ...
            logger.info(
                f"PagerDuty alert sent: {alert.title}",
                extra={"alert_id": alert.alert_id}
            )
            return True
