...
class TestStartupChecks:
    ...
    def test_startup_checks_loads_config_if_not_provided(self, valid_config_file, capsys, monkeypatch):
        """Test that startup_checks loads config if not provided."""
        # Mock the default config path
        monkeypatch.setattr("shared.startup.validate_startup_config", 
