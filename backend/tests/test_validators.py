...
class TestPlatformValidation:
    ...
    def test_invalid_environment(self):
        ...
        config_data = {
            "platform": {"name": "Test", "version": "1.0.0", "environment": "invalid_env"}
        }
        config = Config(config_data)
        validator = ConfigValidator(config)
    ...
    def test_invalid_port_range(self):
        ...
        config_data = {
            "api": {
                ...
                "jwt": {"secret_key": "test", "expiration_hours": 24},
            }
        }
        config = Config(config_data)
        validator = ConfigValidator(config)
    ...
    def test_invalid_expiration_hours(self):
        ...
        config_data = {
            "api": {
                "host": "0.0.0.0",
                "port": 8000,
                "jwt": {"secret_key": "test", "expiration_hours": 1000},  # Too high
            }
        }
        config = Config(config_data)
        validator = ConfigValidator(config)
...
class TestLLMValidation:
    ...
    def test_default_provider_not_found(self):
        ...
        config_data = {
            "llm": {
                ...
                "providers": {"ollama": {"enabled": True, "models": {"chat": "llama3"}}},
            }
        }
        config = Config(config_data)
        validator = ConfigValidator(config)
    ...
    def test_default_provider_not_enabled(self):
        ...
        config_data = {
            "llm": {
                "default_provider": "ollama",
                "providers": {
                    "ollama": {"enabled": False, "models": {"chat": "llama3"}}  # Not enabled
                },
            }
        }
        config = Config(config_data)
    ...
    def test_provider_missing_models(self):
        ...
        config_data = {
            "llm": {
                "default_provider": "ollama",
                "providers": {"ollama": {"enabled": True, "models": {}}},  # No models
            }
        }
        config = Config(config_data)
        validator = ConfigValidator(config)
...
class TestAgentsValidation:
    ...
    def test_min_size_greater_than_max_size(self):
        ...
        config_data = {
            "agents": {
                "pool": {"min_size": 100, "max_size": 10},  # Less than min_size
                "resources": {
                    "default_cpu_cores": 1.0,
                    "default_memory_gb": 2,
                    "max_cpu_cores": 4,
    ...
    def test_data_classification_enabled_without_levels(self):
        ...
        config_data = {
            "security": {
                ...
                "data_classification": {"enabled": True, "levels": []},  # Empty
            }
        }
        config = Config(config_data)
        validator = ConfigValidator(config)
...
class TestMonitoringValidation:
    ...
    def test_invalid_log_level(self):
        ...
        config_data = {"monitoring": {"logging": {"level": "INVALID", "format": "json"}}}
        config = Config(config_data)
        validator = ConfigValidator(config)
    ...
    def test_invalid_log_format(self):
        ...
        config_data = {"monitoring": {"logging": {"level": "INFO", "format": "invalid_format"}}}
        config = Config(config_data)
        validator = ConfigValidator(config)
...
class TestQuotasValidation:
    ...
    def test_negative_quota_value(self):
        ...
        config_data = {
            "quotas": {"default": {"max_agents": -10, "max_storage_gb": 100}}  # Negative
        }
        config = Config(config_data)
        validator = ConfigValidator(config)
...
class TestEnvironmentVariableValidation:
    ...
    def test_production_requires_env_vars(self):
        ...
        config_data = {
            "platform": {"name": "Test", "version": "1.0.0", "environment": "production"}
        }
        config = Config(config_data)
        validator = ConfigValidator(config)
    ...
    def test_development_allows_missing_env_vars(self):
        ...
        config_data = {
            "platform": {"name": "Test", "version": "1.0.0", "environment": "development"},
            "api": {"jwt": {"secret_key": "hardcoded-dev-secret"}},
        }
        config = Config(config_data)
        validator = ConfigValidator(config)
...
class TestErrorMessages:
    ...
    def test_error_messages_are_descriptive(self):
        ...
        config_data = {"api": {"port": 99999}}  # Invalid
        config = Config(config_data)
        validator = ConfigValidator(config)
    ...
    def test_multiple_errors_reported(self):
        ...
        config_data = {
            "platform": {"environment": "invalid"},  # Error 1
            "api": {"port": 99999},  # Error 2
        }
        config = Config(config_data)
        validator = ConfigValidator(config)
