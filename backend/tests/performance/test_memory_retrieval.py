...
class TestMemoryRetrievalPerformance:
    ...
    def test_agent_memory_retrieval_latency(self, memory_interface):
        ...
        p99_latency = statistics.quantiles(retrieval_times, n=100)[98] if len(retrieval_times) >= 100 else max(retrieval_times)
