...
def test_admin_can_access_any_agent(mock_session, admin_user, mock_other_agent):
    ...
    result = verify_agent_ownership(mock_session, str(mock_other_agent.agent_id), admin_user)
...
def test_manager_can_access_any_agent(mock_session, manager_user, mock_other_agent):
    ...
    result = verify_agent_ownership(mock_session, str(mock_other_agent.agent_id), manager_user)
...
def test_user_can_access_own_agent(mock_session, regular_user, mock_agent):
    ...
    result = verify_agent_ownership(mock_session, str(mock_agent.agent_id), regular_user)
...
def test_user_cannot_access_others_agent(mock_session, regular_user, mock_other_agent):
    ...
    result = verify_agent_ownership(mock_session, str(mock_other_agent.agent_id), regular_user)
...
def test_viewer_cannot_access_agent(mock_session, viewer_user, mock_agent):
    ...
    result = verify_agent_ownership(mock_session, str(mock_agent.agent_id), viewer_user)
...
def test_verify_ownership_agent_not_found(mock_session, regular_user):
    ...
    result = verify_agent_ownership(mock_session, str(uuid4()), regular_user)
...
def test_verify_ownership_invalid_role(mock_session, mock_agent):
    ...
    result = verify_agent_ownership(mock_session, str(mock_agent.agent_id), invalid_user)
...
def test_require_ownership_success(mock_session, regular_user, mock_agent):
    ...
    result = require_agent_ownership(mock_session, str(mock_agent.agent_id), regular_user)
...
def test_require_ownership_raises_on_unauthorized(mock_session, regular_user, mock_other_agent):
    ...
    with pytest.raises(PermissionDeniedError):
        require_agent_ownership(mock_session, str(mock_other_agent.agent_id), regular_user)
...
def test_require_ownership_raises_on_not_found(mock_session, regular_user):
    ...
    with pytest.raises(PermissionDeniedError):
        require_agent_ownership(mock_session, str(uuid4()), regular_user)
...
def test_can_update_own_agent(mock_session, regular_user, mock_agent):
    ...
    result = can_update_agent(mock_session, str(mock_agent.agent_id), regular_user)
...
def test_cannot_update_others_agent(mock_session, regular_user, mock_other_agent):
    ...
    result = can_update_agent(mock_session, str(mock_other_agent.agent_id), regular_user)
...
def test_admin_can_update_any_agent(mock_session, admin_user, mock_other_agent):
    ...
    result = can_update_agent(mock_session, str(mock_other_agent.agent_id), admin_user)
...
def test_can_delete_own_agent(mock_session, regular_user, mock_agent):
    ...
    result = can_delete_agent(mock_session, str(mock_agent.agent_id), regular_user)
...
def test_cannot_delete_others_agent(mock_session, regular_user, mock_other_agent):
    ...
    result = can_delete_agent(mock_session, str(mock_other_agent.agent_id), regular_user)
...
def test_admin_can_delete_any_agent(mock_session, admin_user, mock_other_agent):
    ...
    result = can_delete_agent(mock_session, str(mock_other_agent.agent_id), admin_user)
...
def test_can_control_own_agent(mock_session, regular_user, mock_agent):
    ...
    result = can_control_agent(mock_session, str(mock_agent.agent_id), regular_user)
...
def test_cannot_control_others_agent(mock_session, regular_user, mock_other_agent):
    ...
    result = can_control_agent(mock_session, str(mock_other_agent.agent_id), regular_user)
...
def test_get_agent_owner_id_success(mock_session, mock_agent):
    ...
    result = get_agent_owner_id(mock_session, str(mock_agent.agent_id))
...
def test_get_agent_owner_id_not_found(mock_session):
    ...
    result = get_agent_owner_id(mock_session, str(uuid4()))
