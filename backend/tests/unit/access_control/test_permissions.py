...
class TestCurrentUser:
    ...
    def test_has_permission_invalid_role(self):
        ...
        user = CurrentUser(user_id="123", username="john", role="invalid_role")
    ...
    def test_can_access_resource_unrestricted(self):
        ...
        assert manager.can_access_resource(
            ResourceType.AGENTS, Action.READ, resource_owner_id="456"
        )
    ...
    def test_can_access_resource_own_scope_owner(self):
        ...
        assert user.can_access_resource(ResourceType.AGENTS, Action.READ, resource_owner_id="123")
    ...
    def test_can_access_resource_no_permission(self):
        ...
        assert not viewer.can_access_resource(
            ResourceType.AGENTS, Action.CREATE, resource_owner_id="123"
        )
...
class TestRequirePermission:
    ...
    async def test_require_permission_with_ownership_check(self):
        ...
        @require_permission(
            ResourceType.AGENTS, Action.DELETE, scope="own", get_resource_owner=get_agent_owner
        )
...
class TestCheckUserPermission:
    ...
    def test_check_user_permission_granted(self):
        ...
        result = check_user_permission(
            user_role="user", resource_type=ResourceType.AGENTS, action=Action.CREATE
        )
    ...
    def test_check_user_permission_denied(self):
        ...
        result = check_user_permission(
            user_role="viewer", resource_type=ResourceType.AGENTS, action=Action.CREATE
        )
    ...
    def test_check_user_permission_invalid_role(self):
        ...
        result = check_user_permission(
            user_role="invalid_role", resource_type=ResourceType.AGENTS, action=Action.CREATE
        )
        assert result is False
...
class TestLogPermissionDenial:
    ...
    def test_log_permission_denial_basic(self):
        ...
        log_permission_denial(
            user_id="123", resource_type=ResourceType.AGENTS, action=Action.CREATE
        )

    def test_log_permission_denial_with_scope(self):
        """Test logging permission denial with scope."""
        log_permission_denial(
            user_id="123", resource_type=ResourceType.AGENTS, action=Action.DELETE, scope="own"
        )
    ...
    def test_log_permission_denial_string_types(self):
        ...
        log_permission_denial(user_id="123", resource_type="agents", action="create")
...
class TestFilterByPermission:
    ...
    def test_filter_by_permission_unrestricted(self):
        ...
        filtered = filter_by_permission(items, admin, ResourceType.AGENTS, Action.READ)
    ...
    def test_filter_by_permission_own_scope(self):
        ...
        filtered = filter_by_permission(items, user, ResourceType.AGENTS, Action.READ)
    ...
    def test_filter_by_permission_no_permission(self):
        ...
        filtered = filter_by_permission(items, viewer, ResourceType.AGENTS, Action.CREATE)
    ...
    def test_filter_by_permission_custom_owner_field(self):
        ...
        filtered = filter_by_permission(
            items, user, ResourceType.TASKS, Action.READ, owner_id_field="created_by"
        )
...
class TestGetPermissionScope:
    ...
    def test_get_permission_scope_unrestricted(self):
        ...
        scope = get_permission_scope(admin, ResourceType.AGENTS, Action.READ)
    ...
    def test_get_permission_scope_own(self):
        ...
        scope = get_permission_scope(user, ResourceType.AGENTS, Action.READ)
    ...
    def test_get_permission_scope_permitted(self):
        ...
        scope = get_permission_scope(viewer, ResourceType.AGENTS, Action.READ)
    ...
    def test_get_permission_scope_none(self):
        ...
        scope = get_permission_scope(viewer, ResourceType.AGENTS, Action.CREATE)
...
class TestVerifyResourceAccess:
    ...
    async def test_verify_resource_access_granted(self):
        ...
        result = await verify_resource_access(
            user, ResourceType.AGENTS, Action.READ, resource_owner_id="123", raise_on_deny=False
        )
    ...
    async def test_verify_resource_access_denied_no_raise(self):
        ...
        result = await verify_resource_access(
            user, ResourceType.AGENTS, Action.READ, resource_owner_id="456", raise_on_deny=False
        )
    ...
    async def test_verify_resource_access_denied_with_raise(self):
        ...
        with pytest.raises(HTTPException) as exc_info:
            await verify_resource_access(
                user, ResourceType.AGENTS, Action.READ, resource_owner_id="456", raise_on_deny=True
            )
    ...
    async def test_verify_resource_access_unrestricted(self):
        ...
        result = await verify_resource_access(
            admin, ResourceType.AGENTS, Action.READ, resource_owner_id="456", raise_on_deny=False
        )
...
class TestPermissionDeniedError:
    ...
    def test_permission_denied_error_creation(self):
        ...
        error = PermissionDeniedError(
            message="Access denied", user_id="123", resource_type="agents", action="delete"
        )
