...
class TestTokenGeneration:
    ...
    def test_create_token_pair(self, sample_user):
        ...
        access_payload = jwt.decode(
            token_pair.access_token, config["secret_key"], algorithms=[config["algorithm"]]
        )
        refresh_payload = jwt.decode(
            token_pair.refresh_token, config["secret_key"], algorithms=[config["algorithm"]]
        )
...
class TestTokenDataModel:
    ...
    def test_token_data_default_type(self):
        ...
        token_data = TokenData(
            user_id="123e4567-e89b-12d3-a456-426614174000", username="test_user", role="user"
        )
...
class TestTokenPairModel:
    ...
    def test_token_pair_creation(self):
        ...
        token_pair = TokenPair(
            access_token="access.token.here", refresh_token="refresh.token.here", expires_in=86400
        )
