#!/usr/bin/env python3
"""Test llm-pool streaming response format."""

import httpx
import json

url = "https://llm.rotanova.top/api/v1/ai/openai/v1/chat/completions"
headers = {
    "Content-Type": "application/json",
    "Authorization": "Bearer 823ef2a63c48e803121d184d68b1af1be3da920a"
}
data = {
...
print("Testing llm-pool streaming...")
print("=" * 80)
