...
from access_control.registration import (  # noqa: E402
    DuplicateUserError,
    ValidationError,
    register_user_admin,
)
...
def main():
    """Main entry point."""
    parser = argparse.ArgumentParser(description="Create initial admin user for LinX platform")
    parser.add_argument("--username", default="admin", help="Admin username (default: admin)")
    parser.add_argument(
        "--email", default="admin@linx.local", help="Admin email (default: admin@linx.local)"
    )
    parser.add_argument(
