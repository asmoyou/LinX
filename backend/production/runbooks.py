            ...
            steps=[
                ...
                RunbookStep(
	                ...
	                RunbookStep(
	                    ...
	                    command="docker compose logs --tail=100 api-gateway | grep -i error",
                ...
                RunbookStep(
	                ...
	                RunbookStep(
	                    ...
	                    command="docker compose up -d --scale api-gateway=3",
            ...
            steps=[
                RunbookStep(
	                ...
	                RunbookStep(
	                    ...
	                    command="docker compose up -d --scale api-gateway=5",
	                    expected_output="Scaled to 5 instances",
	                ),
	                RunbookStep(
	                    step_number=3,
	                    title="Scale Frontend",
	                    description="Increase frontend instances when UI traffic is high",
	                    command="docker compose up -d --scale frontend=3",
	                    expected_output="Scaled to 3 instances",
	                ),
                RunbookStep(
                    step_number=4,
            ...
            steps=[
                ...
                RunbookStep(
	                ...
	                RunbookStep(
	                    ...
	                    command="docker compose stop api-gateway frontend",
                ...
                RunbookStep(
	                ...
	                RunbookStep(
	                    ...
	                    command="docker compose start api-gateway frontend",
