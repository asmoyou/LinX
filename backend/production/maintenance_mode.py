...
class MaintenanceMode:
    ...
    def cancel_scheduled_maintenance(self, start_time: datetime):
        ...
        """
        self.scheduled_windows = [w for w in self.scheduled_windows if w.start_time != start_time]
    ...
    def get_scheduled_windows(self) -> List[MaintenanceWindow]:
        ...
        # Remove past windows
        now = datetime.now()
        self.scheduled_windows = [w for w in self.scheduled_windows if w.end_time > now]
