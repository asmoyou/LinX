"""Notification repository for the project execution platform.

This module provides CRUD helpers for the user notification center without
keeping the active runtime dependent on the historical mission package namespace.
"""
...
from database.project_execution_models import UserNotification
