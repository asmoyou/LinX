...
class AgentPerformanceAnalytics:
    ...
    def _identify_underperformers(
        ...
        for metrics in metrics_list:
            if (metrics.success_rate < success_rate_threshold or
    ...
    def compare_agent_performance(
        ...
        comparison = {
            ...
            "changes": {
                "tasks_completed": current_metrics.tasks_completed - previous_metrics.tasks_completed,
