    ...
    def _generate_insights(
        ...
        if report.daily_metrics:
            ...
            if avg_completion_rate < 0.8:
                insights.append(f"Average completion rate is {avg_completion_rate:.1%}. Consider investigating failures.")
        
        # Prediction insight
        if report.predicted_next_week_tasks > report.avg_daily_tasks * 7 * 1.2:
            insights.append("Predicted increase in task volume next week. Prepare additional capacity.")
