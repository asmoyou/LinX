...
def mock_milvus_connection():
    ...
    mock_conn.get_collection_stats.return_value = {
...
def memory_system(mock_embedding_service, mock_milvus_connection):
    ...
    with patch('memory_system.memory_system.get_embedding_service', return_value=mock_embedding_service):
        with patch('memory_system.memory_system.get_milvus_connection', return_value=mock_milvus_connection):
            system = MemorySystem()
            return system
