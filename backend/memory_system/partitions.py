...
class PartitionManager:
    ...
    def create_agent_partition(
        self, agent_id: str, collection_name: str = CollectionName.AGENT_MEMORIES
    ) -> str:
        """
    ...
    def create_user_partition(
        self, user_id: str, collection_name: str = CollectionName.COMPANY_MEMORIES
    ) -> str:
        """
    ...
    def create_memory_type_partition(
        self, memory_type: str, collection_name: str = CollectionName.COMPANY_MEMORIES
    ) -> str:
        """
    ...
    def create_access_level_partition(
        self, access_level: str, collection_name: str = CollectionName.KNOWLEDGE_EMBEDDINGS
    ) -> str:
        """
    ...
    def drop_partition(self, collection_name: str, partition_name: str) -> None:
        ...
        try:
            ...
            logger.error(
                f"Failed to drop partition '{partition_name}' from '{collection_name}': {e}"
            )
            raise
