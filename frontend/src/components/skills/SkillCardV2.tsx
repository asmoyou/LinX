...
export default function SkillCardV2({
  ...
  return (
    <div className="glass-panel group relative rounded-2xl overflow-hidden p-6 hover:-translate-y-1 transition-all duration-300 flex flex-col h-full">
      {/* Header */}
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-start gap-3 flex-1">
          <div className={`p-3 rounded-xl ${typeInfo.bgColor} shadow-lg`}>
      ...
      <div className="flex items-center gap-2 mt-auto">
        <button
          ...
          className="flex-1 px-4 py-2.5 rounded-xl bg-primary/10 hover:bg-primary/20 text-primary transition-colors flex items-center justify-center gap-2 text-sm font-medium"
        >
        ...
        {onViewCode && (
          <button
            ...
            className="px-4 py-2.5 rounded-xl bg-muted/50 hover:bg-muted text-foreground transition-colors"
