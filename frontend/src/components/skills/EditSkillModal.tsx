      ...
      <div className="w-full max-w-4xl max-h-[calc(100vh-var(--app-header-height,4rem)-3rem)] overflow-y-auto modal-panel rounded-[24px] shadow-2xl p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold text-zinc-800 dark:text-white">
            {isReadOnly ? t("skills.viewSkill") : t("skills.editSkill")}
          </h2>
          <button
            onClick={handleClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-5">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 rounded-xl glass text-zinc-800 dark:text-white placeholder:text-zinc-500 dark:placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 transition-all resize-none disabled:opacity-70 disabled:cursor-not-allowed"
          ...
          <div className="flex justify-end gap-3 pt-6 border-t border-zinc-200 dark:border-zinc-700">
            <button
              ...
              disabled={isSubmitting}
            >
              {isReadOnly ? t("skills.close") : t("skills.cancel")}
            </button>
            {!isReadOnly && (
              <button
                type="submit"
